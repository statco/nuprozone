export const translations = {
  en: {
    ...
    hero: {
      eyebrow: "Handcrafted in Rouyn-Noranda, Québec",
    ...
    about: {
      ...
      body1: "NUPROZ goat's milk soap is handmade in Rouyn-Noranda, Québec, using fresh goat's milk sourced locally. Every bar is cold-process crafted, loaded with skin-nourishing fats, lactic acids, and vitamins that gently cleanse without stripping.",
      body2: "We produce for wholesale buyers who demand quality their customers can feel — spas, natural health retailers, gift shops, and wellness brands across North America and beyond.",
      stat1: "100%",
    ...
    products: {
      ...
      coming: "Full product catalogue available upon inquiry",
    ...
    footer: {
      tagline: "Handcrafted goat's milk soap. Made in Québec. Shipped worldwide.",
  ...
  fr: {
    ...
    hero: {
      eyebrow: "Artisanal de Rouyn-Noranda, Québec",
    ...
    about: {
      ...
      body1: "Le savon au lait de chèvre NUPROZ est fabriqué à la main à Rouyn-Noranda, Québec, avec du lait de chèvre frais d'origine locale. Chaque barre est élaborée à froid, riche en graisses nourrissantes, acides lactiques et vitamines qui nettoient en douceur.",
      body2: "Nous produisons pour les acheteurs en gros qui exigent une qualité que leurs clients peuvent ressentir — spas, détaillants de santé naturelle, boutiques de cadeaux et marques de bien-être à travers l'Amérique du Nord et au-delà.",
      stat1: "100%",
    ...
    products: {
      ...
      coming: "Catalogue produit complet disponible sur demande",
    ...
    footer: {
      tagline: "Savon artisanal au lait de chèvre. Fabriqué au Québec. Expédié dans le monde entier.",
      address: "Rouyn-Noranda, QC J9Y 1A8, Canada",
      email: "info@nuprozone.com",
